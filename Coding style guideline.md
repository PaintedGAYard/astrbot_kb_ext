...
1. Code **documentation** should only include the following content:
    1. Interface contract,
       ...
       - Only this item is strictly necessary for all code **constructs**. Try your best **not to include** other items.
...
9. For *Non-LLM-facing* interfaces:
    ...
    2. **Do not return** an LLM-prompt-like message unless absolutely necessary. If an LLM-prompt-like message is needed, write a translation function to get the message from end result instead.
